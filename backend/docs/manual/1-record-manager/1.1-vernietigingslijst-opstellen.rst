...
3. **Filters gebruiken**
    ...
    - **Zaken met een verlopen archiefdatum tonen**
      Klik op **“Toon zaken met verlopen archiefdatum”** om alleen zaken te tonen waarvan de archiefactiedatum op of vóór vandaag ligt. |toon_zaken_met_verlopen_archiefdatum|
    - **Filters wissen**
      Deze knop verschijnt zodra er één of meer filters actief zijn.
      Bij gebruik worden alle actieve filters verwijderd. |filters_wissen|
...
.. |toon_zaken_met_verlopen_archiefdatum| image:: ../_assets/toon-zaken-met-verlopen-archiefdatum.png
    :alt: Toon zaken met verlopen archiefdatum
    :height: 32px

.. |filters_wissen| image:: ../_assets/filters-wissen.png
    :alt: Filters wissen
    :height: 32px
