...
Voor het configureren van een vernietigingsrapport moeten de geselecteerde instellingen aan specifieke voorwaarden voldoen.
De voorwaarden zijn per objecttype beschreven. Geneste opsommingen geven afhankelijkheden aan.

Rapport
^^^^^^^
Het vernietigingsrapport bestaat uit de volgende configuratieonderdelen:
