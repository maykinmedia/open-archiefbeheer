...
* Plugins are now available to support destruction in external registries:
  * [#940] Object API plugin, enabling destruction of objects stored in the Object API.
  * [#905] OpenKlant plugin, enabling destruction of objects stored in OpenKlant.
* [#958] The landing page now only shows recently deleted destruction lists.
  ...
  * The number of days (default: 7) a deleted list remains visible can be configured using the `POST_DESTRUCTION_VISIBILITY_PERIOD` environment variable.
