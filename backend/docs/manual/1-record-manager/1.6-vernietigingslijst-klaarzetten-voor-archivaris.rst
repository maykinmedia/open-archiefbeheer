...
- Een beoordelaar moet een beoordeling hebben uitgevoerd en de lijst moet de beslissing **"Geaccepteerd"** bevatten.
- De lijst moet de goedkeuring van de record manager ontvangen voordat deze naar de archivaris kan worden gestuurd.
