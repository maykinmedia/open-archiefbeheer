...
3. **Selectie van gerelateerde objecten bekijken**
    - In de kolom **Gerelateerde objecten** verschijnt een knop om gerelateerde objecten te bekijken. |gerelateerde_objecten_knop|
    - Alleen de geselecteerde gerelateerde objecten worden daadwerkelijk vernietigd.

4. **Goedkeuren van de lijst**
