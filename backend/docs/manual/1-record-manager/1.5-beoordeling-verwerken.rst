...
3. **Selectie van gerelateerde objecten bekijken en bewerken**
    - In de kolom **Gerelateerde objecten** verschijnt een knop om gerelateerde objecten interactief te beheren
      wanneer de lijst niet in bewerkmodus staat en de gebruiker de juiste rechten heeft om gerelateerde objecten te bewerken. |gerelateerde_objecten_knop|
    - Ondersteunde objecten kunnen aangevinkt of uitgevinkt worden; niet-ondersteunde objecten zijn alleen ter informatie
      en altijd uitgeschakeld.
    - Alleen de geselecteerde gerelateerde objecten worden daadwerkelijk vernietigd.
    - Klik op de knop **"Opslaan"** binnen deze sectie om wijzigingen op te slaan.
    - Wijzigingen aan de selectie worden direct doorgevoerd.

4. **Beoordeel de wijzigingen**
    ...
    - Wijzigingen worden doorgevoerd na het opnieuw indienen van de lijst.

5. **Selectielijstklasse aanpassen**
    - Indien nodig, selecteer je de optie **"Selectielijstklasse aanpassen"**.
    - Vul het veld **"Selectielijstklasse"** in, bijvoorbeeld **"11.1 - Verleend - vernietigen - P1Y"**.

6. **Archiefactiedatum aanpassen**
    - Kies de optie **"Archiefactiedatum aanpassen"**.
...
7. **Afwijzen van het voorstel**
    - Kies de optie **"Voorstel afwijzen"** om zaak niet te muteren (en opnieuw aan te bieden aan de
      beoordelaar).
...
.. figure:: ../_assets/muteren-formulier.png
    ...
    Zaak mutatie formulier met keuzes **"Selectielijstklasse aanpassen"**, **"Archiefactiedatum aanpassen"** en
    **"Voorstel afwijzen"**.
...
.. |gerelateerde_objecten_knop| image:: ../_assets/gerelateerde-objecten-knop.png
    :alt: Gerelateerde objecten bekijken
    :height: 26px
