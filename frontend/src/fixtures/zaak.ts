...
import { relatedObjectsSelectionItemsFactory } from "./relatedObjectsSelection";

const ZAAKOBJECT_URLS = relatedObjectsSelectionItemsFactory(new Array(3)).map(
  (v) => v.url,
);
