...
- Open Zaak moet beschikken over correct ingerichte en gepubliceerde gegevensobjecten die voldoen aan de hieronder
...
- De zaak krijgt:
  ...
  - Een resultaat met het geconfigureerde resultaattype.
  - Optioneel een status met het geconfigureerde statustype.
...
5. **Controleer de configuratie**
    - Nadat de configuratie van het verklaring van vernietiging is opgeslagen staan de ingevulde gegevens
